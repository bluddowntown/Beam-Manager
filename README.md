...
Before you download Beam-Manager, please make sure your computer meets these basic requirements:
...
This section will walk you through downloading, installing, and running Beam-Manager. It includes all steps you need, from getting the program to managing your mods.

### 1. Download Beam-Manager
...
Here are the main tasks you can do with Beam-Manager:

### View Mods

- The app shows a list of installed mods, with names, types, and important details.
- Click on any mod to see information like version, description, and contained vehicles.

### Add New Mods

- Click the "Add Mod" button.
- Browse your computer for mod files (usually `.zip` or `.rar`).
- Beam-Manager will install the mod into the right folder automatically.
...
- Open any vehicle mod to view detailed settings.
- You can see or change parameters such as paint color, engine specs, and more.
- Changes save automatically and apply next time you start the game.

### Manage Metadata

- Beam-Manager lets you edit mod metadata (author name, description, version).
- This is useful if you want to keep your mod collection organized.

### Instant Binary Caching

- The app loads mod binaries faster, improving performance.
- You won’t need to wait long for mod previews or inspections.
...
For more help, visit the project’s GitHub Issues page or community forums.
...
Beam-Manager was built using C# and runs on .NET 6.0. It uses Windows Forms to give you a native Windows experience. The program focuses on speed, stability, and ease of use for vehicle modding.
...
Beam-Manager is an open-source project licensed under the MIT License. You can use, modify, and share it freely.
